...
export default async function walletCreate(args, flags) {
  ...
  try {
    ...
    // Mimix fork: skip the YES backup acknowledgement when the passphrase
    // came from MIMIX_PASSPHRASE — persona wallets are ephemeral and the
    // operator already managed the secret out-of-band.
