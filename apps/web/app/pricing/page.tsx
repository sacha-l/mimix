...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      { included: true, text: "Reference DemoPay target dApp" },
      { included: true, text: "Real signed onchain transactions on Solana devnet via the forked Zerion CLI" },
      { included: true, text: "Hand-authored persona observations" },
      { included: true, text: "Full event log + report with Solscan links" },
      { included: false, text: "Real LLM-driven exploration" },
      { included: false, text: "Test any production dApp" },
      { included: false, text: "Mainnet settlement" },
    ],
  },
  {
    name: "Starter",
    tagline: "Real AI personas, hosted by Mimix.",
    price: "$5",
    unit: "USDG · per persona-run",
    cta: "Coming soon",
    ctaHref: "#",
    ctaDisabled: true,
    highlight: true,
    features: [
      ...
      { included: true, text: "Real Claude Sonnet 4.5 exploration (vision + tool-use)" },
      { included: true, text: "10-turn budget per persona" },
      { included: true, text: "Any Solana devnet dApp URL" },
      { included: true, text: "Persona-voice observations generated per run" },
      { included: true, text: "Aggregate cross-persona summary report" },
      { included: false, text: "Mainnet settlement" },
      { included: false, text: "Custom personas" },
    ],
  },
  {
    name: "Pro",
    tagline: "Deep exploration on production dApps.",
    price: "$25",
    unit: "USDC · per persona-run",
    cta: "Talk to us",
    ctaHref: "mailto:hello@mimix.app",
    ctaDisabled: true,
    features: [
      { included: true, text: "Everything in Starter" },
      { included: true, text: "40-turn budget per persona" },
      { included: true, text: "Solana mainnet — real USDC settlement" },
      { included: true, text: "Bring-your-own persona YAML" },
      { included: true, text: "Priority queue" },
      { included: true, text: "Slack & webhook delivery" },
      { included: true, text: "Regression replay (re-run a previous test against new commits)" },
    ],
  },
];
